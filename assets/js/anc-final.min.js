...
app.controller('mainController', ["$scope", "$log", "$window", "$timeout", "$state", "cast", "md5", function ($scope, $log, $window, $timeout, $state, cast, md5) {
...
app.controller('resultsController', ["$scope", "$timeout", "$state", "cast", function ($scope, $timeout, $state, cast) {
